...
# recommendation method using the cosine similarity
def rcmd(m):
    m = m.lower()
    try:
        data.head()
...
#Suggestions method for front end
def get_suggestions():
    data = pd.read_csv('main_data.csv')
...
#recommending movies while taking data from the form
...
#https://github.com/kishan0725/AJAX-Movie-Recommendation-System-with-Sentiment-Analysis/tree/master/.ipynb_checkpoints
